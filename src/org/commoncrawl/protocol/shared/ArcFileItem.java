...
public class ArcFileItem extends org.commoncrawl.rpc.RPCStruct<ArcFileItem>  implements Writable{
  ...
  public final ArcFileItem  setFieldDirty(int fieldId) { __validFields.set(fieldId); return this; }
  
  public final ArcFileItem  setFieldClean(int fieldId) { __validFields.clear(fieldId); return this; }
